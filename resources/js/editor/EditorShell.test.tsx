...
describe('EditorShell', () => {
    ...
    it('collapses each controlled desktop panel into a zero-width inert track and restores its saved width', async () => {
        ...
        rerender(<EditorShell {...props} libraryOpen={false} inspectorOpen />)
        expect(screen.queryByRole('button', { name: 'Library action' })).toBeNull()
        expect(screen.getByText('Library region').closest('aside')).toHaveAttribute('hidden')
        expect(screen.getByText('Library region').closest('aside')).toHaveAttribute('inert')
        expect(screen.getByText('Library region').closest('aside')).toHaveAttribute('aria-hidden', 'true')
        ...
        expect(screen.getByRole('button', { name: 'Collapse Node Library' })).toHaveFocus()
        ...
        rerender(<EditorShell {...props} libraryOpen inspectorOpen={false} />)
        expect(screen.getByText('Inspector region').closest('aside')).toHaveAttribute('hidden')
        expect(screen.getByText('Inspector region').closest('aside')).toHaveAttribute('inert')
        expect(screen.getByText('Inspector region').closest('aside')).toHaveAttribute('aria-hidden', 'true')
        ...
        expect(props.onInspectorOpenChange).toHaveBeenLastCalledWith(true)
        rerender(<EditorShell {...props} libraryOpen inspectorOpen />)
        expect(screen.getByRole('button', { name: 'Collapse Inspector' })).toHaveFocus()
